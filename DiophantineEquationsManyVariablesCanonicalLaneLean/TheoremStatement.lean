...
def sourceRepository : String :=
  "diophantine-equations-many-variables-canonical-lane"

def sourceDescription : String :=
  "Solution existence and finiteness for systems of Diophantine equations in many variables"

def baselineCertificateLane : String :=
  "diophantine_constrained"
...
def ManifoldConstrainedTheoremClosed : Prop :=
  baselineCertificateLane = "diophantine_constrained" ∧
